...
// var httpRequestUrl = "http://139.129.119.220:8088";
var httpRequestUrl = "http://localhost:8085";
// var httpRequestUrl = "http://192.168.100.5:8085";
/**
 * 加载公共的头
 */
function header() {
    ...
    header += '</div>\n' +
        ...
        '                        </a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="user-name" href="excelUser.html" id="gotoUserManage">待问卷人员管理</a>\n' +
 ...
 * @param success     成功之后的回调函数
 */
function commonAjaxGet(async, url, success, err) {
    $.ajax({
        "async": async,
        "url": httpRequestUrl + url,
        "type": "GET",
