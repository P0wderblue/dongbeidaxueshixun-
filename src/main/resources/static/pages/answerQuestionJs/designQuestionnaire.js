...
function editFinish() {
    ...
    if (questionList.length == 0) {
        ...
        questionnaire.questionName=questionName;
        questionnaire.questionContent=questionContent;
        questionnaire.questionList=JSON.stringify(questionList);

        var urlQ ='';
        if(questionnaire != null && questionnaire.id !== 0){
             urlQ = '/questionnaire/editQuestionnaire';
        }else{
             urlQ = '/questionnaire/saveQuestionnaire';
...
function queryQuestionnaire(questionList){
    for (var i = 0; i < questionList.length; i++) {
